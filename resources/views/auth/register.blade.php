...
<x-guest-layout>
    ...
    <h4 class="text-2xl font-bold dark:text-white text-center mt-4">Register</h4>
    <p class="text-sm text-gray-400 dark:text-white text-center mb-6 ">Daftar untuk dapat menjadi bagian dalam
        pengelola
        website.</p>
