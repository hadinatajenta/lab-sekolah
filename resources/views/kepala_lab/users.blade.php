        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-4">
                <div class="p-6 text-gray-900">
                    <div class="mb-4">
                        <h4 class="font-bold text-2xl">Daftar Guru</h4>
            ...
            <div class="bg-white overflow-hidden  sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex items-center mb-3 justify-between">
                        ...
                        @else
                            <span class="text-gray-600">Daftar Guru</span>
                        @endif
                        <!-- Tambah user modal -->
                        ...
                        {{-- search --}}
                        <form class="flex items-center" action="{{ route('pengguna.view') }}" method="GET">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text" id="simple-search"
                                    ...
                                    placeholder="Cari guru ... " name="cari">
                            </div>
                            <button type="submit"
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th scope="col"
                                        class="px-6 py-3 @if (Auth::user()->role_id != 1) hidden @endif">
                                        Aksi
                                    </th>
                                </tr>
                            </thead>
                                ...
                                @foreach ($users as $index => $kl)
                                    <tr
                                        ...
                                        <td class="flex items-center px-6 py-4 ">
                                            {{-- Button edit --}}
                                            @if (Auth::user()->role_id !== 1 || (Auth::user()->role_id == 3 && $kl->role_id == 1))
